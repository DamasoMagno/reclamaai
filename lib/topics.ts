...
export const topicSeed: Topic[] = [
  {
    ...
    contacts: [
      ...
      },
      {
        ...
        lines: ["Gabinete: (88) 1234-5678", "Email: maria.lucia@camara.itapipoca.gov.br"],
      },
    ],
    comments: [
      {
    ...
    impactMetric: {
      ...
      value: 0.82,
      description: "82% das ruas do bairro relatadas pela comunidade continuam sem manutenção.",
    },
  },
  {
    id: "potholes",
    ...
    lastComplaintAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 5).toISOString(),
    contacts: [
      {
    ...
    impactMetric: {
      ...
      value: 0.64,
      description: "64% da avenida foi classificada como crítica pela comunidade.",
    },
  },
  {
    id: "transport",
    ...
    lastComplaintAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 1).toISOString(),
    contacts: [
      {
    ...
    impactMetric: {
      ...
      value: 0.75,
      description: "75% das linhas atendidas pela plataforma foram classificadas como superlotadas.",
    },
  },
  {
    id: "nursery",
    ...
    lastComplaintAt: new Date(Date.now() - 1000 * 60 * 60 * 24 * 7).toISOString(),
    comments: [],
    peopleAffected: 960,
    socialImpact: "Médio",
    detailedDescription: [
    ...
    impactMetric: {
      ...
      value: 0.6,
      description: "60% das famílias cadastradas ainda aguardam uma vaga disponível.",
    },
  },
]
